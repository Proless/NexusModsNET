...
namespace NexusModsNET.Inquirers
{
	...
	public class ColourSchemesInquirer : InquirerBase
	{
		...
		public ColourSchemesInquirer(NexusModsAPIClient client) : base(client) { }
		...
		/// <returns></returns>
		public Task<IEnumerable<NexusColourScheme>> GetAsync(CancellationToken cancellationToken = default)
		{
